...
export default function AdminLegalPage() {
  ...
  const [form, setForm] = useState({
    terms_notice: 'y2matevideo.com is provided as is without warranty of any kind. You must only process media you own or have explicit permission to download.',
